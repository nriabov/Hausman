function [ tsls_pow, post_haus_pow ] = local_power(R, alpha, beta_1, beta_2, h_1, h_2, lambda )
...
%psi values to be simulated and the rest of the values are as given in the
...
% Generate output
tsls_pow = sum(psi_sum > z) / length(psi_sum);
