function [ eta_1, eta_2, eta_3, xi_2] = Eta_gen_comb( h_vec, psi_up, psi_vp, psi_uvp, s_vec, k_2 )
...
% [ eta_1, eta_2, eta_3, xi_2 ] = Eta_gen(s_vec, psi_up, h_vec, xi_2 )
...
%   If nargout == 3, ...
%   If nargout == 4, output xi_2 as well
...
if nargout >= 2
    ...
    if nargout >= 3
        eta_3 = h_sum .* (eta_1 - h_2 * h_sum^(-1) * xi_2).^2;
    end
end
