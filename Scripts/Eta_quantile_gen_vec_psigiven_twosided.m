function [ eta_quant_mat ] = Eta_quantile_gen_vec_psigiven_twosided(psi_up, psi_vp, psi_uvp, k_2, h_1, h_2, s_vec, alpha, beta )
...
% |alpha| matrix of quantiles of eta_star computed for a given vector of 
% h_1 and other parameter values
% [ eta_quant_mat ] = Eta_quantile_gen(psi_up, psi_vp, psi_uvp, k_2, h_1, h_2, s_vec, alpha, beta )

% Generate eta_{1:3},h as in equation 17 from psi vectors provided.
[eta_1, eta_2, eta_3] =  Eta_gen_comb_vec(h_1, h_2, psi_up, psi_vp, psi_uvp, s_vec, k_2);

% Generate eta_h_star, as in equation 20
eta_star = Eta_star_gen_vec( eta_1, eta_2, eta_3, beta);
