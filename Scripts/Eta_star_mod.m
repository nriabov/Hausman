function [ eta_lhs ] = Eta_star_mod( eta_1, eta_2, eta_3, beta, lambda, h_2)
...
% Compute eta_lhs
eta_lhs = bsxfun(@times, bsxfun(@plus, fac_1', eta_2),  eta3_leq) ...
    + bsxfun(@times, bsxfun(@plus, fac_2', eta_1), eta3_more);
